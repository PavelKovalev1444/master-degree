            ...
            query = """
                ...
                WITH 
                    ...
                    reduce(
                        ...
                        total + (
                            CASE 
                                WHEN classifiers[i] = ux_classifiers[i] THEN
                                    CASE 
                                        WHEN abs(features[i] - ux_features[i]) <= 0.1 THEN 1.0
                                        WHEN abs(features[i] - ux_features[i]) <= 0.3 THEN 0.7
                                        WHEN abs(features[i] - ux_features[i]) <= 0.5 THEN 0.4
                                        ELSE 0.1
                                    END
                                ELSE 0.0
                            END
